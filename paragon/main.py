...
try:
    ...
    from paragon.states.transitions.main_state_to_select_project_transition import (
        MainStateToSelectProjectTransition,
    )
    from paragon.states.transitions.reload_project_transition import (
        ReloadProjectTransition,
    )
    from paragon.states.transitions.select_project_to_loading import (
        SelectProjectToLoadingTransition,
    )
    ...
    from paragon.states.transitions.find_project_to_loading import (
        FindProjectToLoadingTransition,
    )
except:
